...
def test_bs_out():
    ...
    keys = [
        ...
        bytearray([
            0xff, 0xfe, 0xfd, 0x00, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b
        ]),
    ]
    texts = [
        bytearray([
        ...
        bytearray([
            0x01, 0x03, 0x05, 0x01, 0x07, 0x09, 0x01, 0x00, 0x03, 0x09, 0x0a, 0x0b
        ]),
    ]
    results = [
        bytearray([
        ...
        bytearray([
            0xbb, 0x54, 0x41, 0x7c, 0x7b, 0xfe, 0xc5, 0xc5, 0x2b, 0x63, 0x63, 0x63
        ]),
    ]
    # yapf: enable
...
def test_inverse():
    ...
    keys = [
        ...
        bytearray([
            0xa8, 0x30, 0x11, 0xbf, 0x94, 0x65, 0x31, 0x12, 0x4c, 0x98, 0xdd, 0xee
        ]),
    ]
    texts = [
        bytearray([
        ...
        bytearray([
            0x93, 0x21, 0x00, 0x41, 0x14, 0x57, 0x32, 0x01, 0xef, 0xcd, 0xab, 0xef
        ]),
    ]
    # yapf: enable
