...
class PicoScope(AbstractSScope):
    ...
    COUPLING_T: TypeAlias = Literal[
        "AC",
        "DC",
        "DC50",
    ]
    ATTENUATION_T: TypeAlias = Literal[
        "1:1",
        "1:10",
    ]
    BW_LIMIT_T: TypeAlias = Literal[
        "PICO_BW_FULL",
        "PICO_BW_20MHZ",
        "PICO_BW_200MHZ",
    ]
    RESOLUTION_T: TypeAlias = Literal[
        "PICO_DR_8BIT",
        "PICO_DR_10BIT",
        "PICO_DR_12BIT",
        "PICO_DR_14BIT",
    ...
    def __init__(
        ...
        *,
        ...
        sample_rate: float,
        offset: int,
        trace_channel: CHANNEL_T,
        trace_probe_range: float,
        trace_coupling: COUPLING_T,
        trace_attenuation: ATTENUATION_T,
        trace_bw_limit: BW_LIMIT_T,
        trace_ignore_overflow: bool,
        trigger_channel: CHANNEL_T,
        trigger_hysteresis: Optional[str],
        trigger_pin: Optional[int],
        trigger_range: float,
        trigger_level: float,
        ...
        **_: Any,
        ...
        Args:
          ...
          setting will be the closest PicoScope sampling rate that is at least
          sample_rate.
          ...
          trace_attenuation (str): Which attenuation to use, either 1:1 or
          1:10.  For BNC-SMA pigtail use "1:1", for oscilloscope passive probe
          use "1:10".
          ...
          "C", "D", (if the scope has those "E", "F", "G", "H"). If the scope
          has digital ports then "PORT0" and "PORT1".
          ...
          trigger_range (float): Should be in [0.02, 0.05, 0.1, 0.2, 0.5, 1.0,
          2.0, 5.0, 10.0, 20.0, 50.0] (in V). Analog trigger only.
          ...
          resolution (RESOLUTION_T): The resolution of the given PicoScope. For
          PicoScope6424E PICO_DR_8BIT, PICO_DR_10BIT, and PICO_DR_12BIT are
