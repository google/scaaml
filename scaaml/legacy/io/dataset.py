...
from scaaml.legacy.utils import bytelist_to_hex
from scaaml.legacy.io.spell_check import find_misspellings
import scaaml.legacy.io.utils as siutils
...
class Dataset():
    ...
    def get_dataset(*args, **kwargs):
        ...
        Args: Same as scaaml.legacy.io.Dataset.__init__
    ...
    def from_config(dataset_path: str, verbose: bool = True):
        ...
        Raises: ValueError if the dataset version is higher than the scaaml
          module used. See scaaml.legacy.__version__ docstring.
        """
        dpath = Path(dataset_path)
        conf_path = Dataset._get_config_path(dataset_path)
        if verbose:
