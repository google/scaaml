...
from scaaml.legacy.capture.crypto_input import AbstractCryptoInput
from scaaml.legacy.capture.crypto_alg import AbstractSCryptoAlgorithm
from scaaml.legacy.capture.communication import AbstractSCommunication
from scaaml.legacy.capture.control import AbstractSControl
from scaaml.legacy.capture.scope import AbstractSScope
...
class AbstractCaptureRunner(ABC):
    ...
    def get_attack_points_and_measurement(
        ...
        Returns: Attack points and physical measurement. These are to be used
          directly by scaaml.legacy.io.Dataset.write_example.
