...
from scaaml.legacy.capture.scope import PicoScope, CWScope, DefaultCWScope
...
def capture_aes_dataset(
    ...
    Args:
      ...
      description: Short description for the scaaml.legacy.io.Dataset.
      ...
      measurements_info: Measurements info for scaaml.legacy.io.Dataset (what is
...
def _capture(scope_class, capture_info: Dict[str, Any], chip_id: int,
    ...
    Args:
      ...
      crypto_algorithms (List[SCryptoAlgorithm]): List of key, plaintext
        generators.
      dataset (scaaml.legacy.io.Dataset): The dataset to save examples to.
    """
